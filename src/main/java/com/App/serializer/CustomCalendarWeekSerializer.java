...
public class CustomCalendarWeekSerializer extends JsonSerializer<Calendar> {
    ...
    public void serialize(Calendar value, JsonGenerator gen, SerializerProvider arg2)
        ...
        if (value == null) {
        	...
        	SimpleDateFormat FORMATTER = new SimpleDateFormat("EE dd/MM/yyyy HH:mm", Locale.getDefault());
